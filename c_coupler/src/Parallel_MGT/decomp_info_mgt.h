...
class Decomp_info_mgt
{
    ...
    public:
        ...
        int register_H2D_parallel_decomposition(const char *, int, int, const int *, int, const int *, const char *);
		...
		Decomp_info *generate_default_parallel_decomp(Original_grid_info *);
};
