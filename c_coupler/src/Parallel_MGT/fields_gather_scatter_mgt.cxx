...
{
    int num_local_cells, i, field_total_dim_size_before_H2D, field_total_dim_size_after_H2D;
	...
	local_field->get_total_dim_size_before_and_after_H2D(field_total_dim_size_before_H2D, field_total_dim_size_after_H2D);
    if (num_local_cells > 0) {
        num_levels = field_total_dim_size_after_H2D;
        num_points_in_each_cell = local_field->get_size_of_field() / num_local_cells / num_levels;
	...
	EXECUTION_REPORT(REPORT_ERROR, -1, num_levels == field_total_dim_size_after_H2D, "Software error in Gather_scatter_rearrange_info: empty parallel decomposition");
...
Field_mem_info *Gather_scatter_rearrange_info::gather_field(Field_mem_info *local_field_mem)
{
    ...
    if (get_data_type_size(data_type) == 1) {
        MPI_Gatherv(local_field_mem->get_data_buf(), local_field_mem->get_size_of_field(), MPI_CHAR, 
        ...
        MPI_Gatherv(local_field_mem->get_data_buf(), local_field_mem->get_size_of_field(), MPI_SHORT, 
        ...
        MPI_Gatherv(local_field_mem->get_data_buf(), local_field_mem->get_size_of_field(), MPI_INT, 
        ...
        MPI_Gatherv(local_field_mem->get_data_buf(), local_field_mem->get_size_of_field(), MPI_DOUBLE, 
