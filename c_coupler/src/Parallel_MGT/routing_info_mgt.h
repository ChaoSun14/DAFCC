...
public:
    ...
    private:
        ...
        Routing_info_with_one_process *compute_routing_info_between_decomps(int, const int*, const int*, int, const int*, int, int, int, bool, routing_mapping_table_entry*, int);
		Routing_info_with_one_process *generate_routing_info_between_procs(routing_mapping_table_entry *, int, int, const int *, bool);
};
