...
void get_API_hint(int comp_id, int API_id, char *API_label)
{
    switch(API_id) {
        ...
        case API_ID_COMP_MGT_REG_COMP:
            ...
            break;
		case API_ID_COMP_MGT_REG_ENSEMBLE_SET:
            sprintf(API_label, "CCPL_register_ensemble_set_of_components");
            break;			
		case API_ID_COMP_MGT_RECORD_ENSEMBLE_RELATION:
			sprintf(API_label, "CCPL_record_ensemble_set_member_relationship");
            break;
        ...
        case API_ID_COMP_MGT_GET_COMP_ID:
            ...
            break;
        case API_ID_COMP_MGT_GET_PARENT_COMP_ID:
            sprintf(API_label, "CCPL_get_parent_id_of_component");
            break;			
         case API_ID_COMP_MGT_GET_COMP_COMM:
            sprintf(API_label, "CCPL_get_component_comm");
            break;			
        ...
        case API_ID_COMP_MGT_GET_COMP_PROC_GLOBAL_ID:
            ...
            break;
		case API_ID_GRID_MGT_REG_H2D_GRID_WITHOUT_DATA:
            sprintf(API_label, "CPL_register_H2D_grid_without_data");
            break;			
        ...
        case API_ID_GRID_MGT_REG_MID_POINT_GRID:
            ...
            break;
		case API_ID_GRID_MGT_REG_NORMAL_1D_GRID_NO_DATA:
			sprintf(API_label, "CCPL_register_1D_normal_grid_without_data");
			break;
        ...
        case API_ID_GRID_MGT_REG_MD_GRID_VIA_MULTI_GRIDS:
            ...
            break;            
        case API_ID_DECOMP_MGT_REG_NORMAL_DECOMP:
            sprintf(API_label, "CCPL_register_normal_parallel_decomp");
            break;
        case API_ID_DECOMP_MGT_REG_CHUNK_DECOMP:
            sprintf(API_label, "CCPL_register_chunk_parallel_decomp");
            break;
		case API_ID_DECOMP_MGT_GET_NUM_CHUNKS:
            sprintf(API_label, "CCPL_get_decomp_num_chunks");
            break;
		case API_ID_DECOMP_MGT_GET_CHUNKS_SIZE:
            sprintf(API_label, "CCPL_get_decomp_chunks_size");
            break;			
		case API_ID_DECOMP_MGT_GET_GRID_SIZE:
			sprintf(API_label, "CCPL_get_decomp_grid_size");
			break;
        case API_ID_DECOMP_MGT_REG_HALO:
            sprintf(API_label, "CCPL_register_halo_region");
            break;
        case API_ID_FIELD_MGT_REG_FIELD_INST:
            sprintf(API_label, "CCPL_register_field_instance");
            break;
		case API_ID_FIELD_MGT_GET_FIELD_INST_GRID_ID:
            sprintf(API_label, "CCPL_get_field_inst_grid_id");
            break;			
		case API_ID_FIELD_MGT_COPY_FIELD_INST_DATA:
			sprintf(API_label, "CCPL_copy_field_inst_data");
			break;
		case API_ID_FIELD_MGT_START_CHUNK_FIELD_INST_REG:
			sprintf(API_label, "CCPL_start_chunk_field_instance_registration");
            break;
		case API_ID_FIELD_MGT_REG_FIELD_INST_CHUNK:
			sprintf(API_label, "CCPL_register_chunk_of_field_instance");
            break;			
		case API_ID_FIELD_MGT_FINISH_CHUNK_FIELD_INST_REG:
			sprintf(API_label, "CCPL_finish_chunk_field_instance_registration");
            break;
		case API_ID_FIELD_MGT_REPORT_FIELD_INST_CKSUM:
			sprintf(API_label, "CCPL_report_one_field_instance_checksum");
            break;
		case API_ID_FIELD_MGT_REPORT_ALL_FIELD_INST_CKSUM:
			sprintf(API_label, "CCPL_report_all_field_instances_checksum");
            break;			
        ...
        case API_ID_TIME_MGT_IS_MODEL_RUN_ENDED:
            ...
            break;
        case API_ID_INTERFACE_REG_HALO_EXCHANGE:
            sprintf(API_label, "CCPL_register_halo_exchange_interface");
            break;
        ...
        case API_ID_INTERFACE_EXECUTE_WITH_NAME:
            ...
            break;
        case API_ID_INTERFACE_DO_HALO_WITH_ID:
            sprintf(API_label, "CCPL_execute_halo_exchange_using_id");
            break;
        case API_ID_INTERFACE_DO_HALO_WITH_NAME:
            sprintf(API_label, "CCPL_execute_halo_exchange_using_name");
            break;
        case API_ID_INTERFACE_FIN_HALO_WITH_ID:
            sprintf(API_label, "CCPL_finish_halo_exchange_using_id");
            break;
		case API_ID_INTERFACE_CHECK_DATA_NAN_INF:
			sprintf(API_label, "CCPL_check_data_NaN_Inf");
			break;
        case API_ID_INTERFACE_FIN_HALO_WITH_NAME:
            sprintf(API_label, "CCPL_finish_halo_exchange_using_name");
			break;
		...
		case API_ID_INTERFACE_GET_SENDER_TIME:
			...
			break;
		case API_ID_EXTERNAL_PROC_INST_INIT:
			sprintf(API_label, "CCPL_external_procedures_inst_init");
			break;
		case API_ID_EXTERNAL_PROC_INST_RUN:
			sprintf(API_label, "CCPL_external_procedures_inst_run");
			break;
		case API_ID_EXTERNAL_PROC_INST_FINALIZE:
			sprintf(API_label, "CCPL_external_procedures_inst_finalize");
			break;			
		case API_ID_EXTERNAL_PROC_INST_GET_COMM:
			sprintf(API_label, "CCPL_external_procedures_get_local_comm");
			break;			
		case API_ID_EXTERNAL_PROC_INST_GET_COMP:
			sprintf(API_label, "CCPL_external_procedures_get_comp_ID");
			break;	
		case API_ID_EXTERNAL_PROC_INST_GET_PROC_ACTIVE:
			sprintf(API_label, "CCPL_external_procedures_is_active_process");
			break;				
		case API_ID_EXTERNAL_PROC_INST_GET_NUM_GRID_DECOMPS:
			sprintf(API_label, "CCPL_external_procedures_para_get_num_grid_decomps");
			break;
		case API_ID_EXTERNAL_PROC_INST_GET_NUM_CONTROLS:
			sprintf(API_label, "CCPL_external_procedures_para_get_num_control_vars");
			break;			
		case API_ID_EXTERNAL_PROC_INST_GET_NUM_TIMERS:
			sprintf(API_label, "CCPL_external_procedures_para_get_num_timers");
			break;
		case API_ID_EXTERNAL_PROC_INST_GET_NUM_FIELDS:
			sprintf(API_label, "CCPL_external_procedures_para_get_num_fields");
			break;
		case API_ID_EXTERNAL_PROC_INST_GET_CONTROL_VAR:
			sprintf(API_label, "CCPL_external_procedures_para_get_control_var");
			break;
		case API_ID_EXTERNAL_PROC_INST_GET_GRID_ID:
			sprintf(API_label, "CCPL_external_procedures_para_get_grid_ID");
			break;
		case API_ID_EXTERNAL_PROC_INST_GET_DECOMP_ID:
			sprintf(API_label, "CCPL_external_procedures_para_get_decomp_ID");
			break;
		case API_ID_EXTERNAL_PROC_INST_GET_TIMER_ID:
			sprintf(API_label, "CCPL_external_procedures_para_get_timer_ID");
			break;
		case API_ID_EXTERNAL_PROC_INST_GET_FIELD_ID:
			sprintf(API_label, "CCPL_external_procedures_para_get_field_ID");
			break;
		case API_ID_EXTERNAL_PROC_INST_DECLARE_FIELD:
			sprintf(API_label, "CCPL_external_procedures_para_declare_field");
			break;			
		case API_ID_EXTERNAL_PROC_INST_GET_FIELD_PTR:
			sprintf(API_label, "CCPL_external_procedures_para_get_field_pointer");
			break;			
		case API_ID_EXTERNAL_SCRIPT_EXE_KEYWORD:
			sprintf(API_label, "CCPL_execute_external_script_via_keyword");
			break;			
		case API_ID_EXTERNAL_SCRIPT_EXE_FILENAME:
			sprintf(API_label, "CCPL_execute_external_script_via_file_name");
			break;
        ...
        case API_ID_COUPLING_GEN_GET_COMPS:
            ...
            break;
        case API_ID_ENSEMBLE_PROC_INST_INIT:
            sprintf(API_label, "CCPL_ensemble_procedures_inst_init");
            break;
        case API_ID_ENSEMBLE_PROC_INST_RUN:
            sprintf(API_label, "CCPL_ensemble_procedures_inst_run");
            break;
        case API_ID_ENSEMBLE_PROC_INST_GET_COMM:
            sprintf(API_label, "CCPL_ensemble_procedures_get_local_comm");
            break;          
        case API_ID_ENSEMBLE_PROC_INST_GET_COMP:
            sprintf(API_label, "CCPL_ensemble_procedures_get_comp_ID");
            break;  
        case API_ID_ENSEMBLE_PROC_INST_GET_PROC_ACTIVE:
            sprintf(API_label, "CCPL_ensemble_procedures_is_active_process");
            break;              
        case API_ID_ENSEMBLE_PROC_INST_GET_NUM_GRID_DECOMPS:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_num_grid_decomps");
            break;
        case API_ID_ENSEMBLE_PROC_INST_GET_NUM_CONTROLS:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_num_control_vars");
            break;          
        case API_ID_ENSEMBLE_PROC_INST_GET_NUM_TIMERS:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_num_timers");
            break;
        case API_ID_ENSEMBLE_PROC_INST_GET_NUM_FIELDS:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_num_fields");
            break;
        case API_ID_ENSEMBLE_PROC_INST_GET_CONTROL_VAR:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_control_var");
            break;
        case API_ID_ENSEMBLE_PROC_INST_GET_GRID_ID:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_grid_ID");
            break;
        case API_ID_ENSEMBLE_PROC_INST_GET_DECOMP_ID:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_decomp_ID");
            break;
        case API_ID_ENSEMBLE_PROC_INST_GET_TIMER_ID:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_timer_ID");
            break;
        case API_ID_ENSEMBLE_PROC_INST_GET_FIELD_ID:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_field_ID");
            break;
        case API_ID_ENSEMBLE_PROC_INST_DECLARE_FIELD:
            sprintf(API_label, "CCPL_ensemble_procedures_para_declare_field");
            break;          
        case API_ID_ENSEMBLE_PROC_INST_GET_FIELD_PTR:
            sprintf(API_label, "CCPL_ensemble_procedures_para_get_field_pointer");
		case API_ID_NORMAL_TIMING_START:
            sprintf(API_label, "CCPL_start_normal_timing");
            break;			
	    case API_ID_NORMAL_TIMING_STOP:
            sprintf(API_label, "CCPL_stop_normal_timing");
            break;
        default:
...
void synchronize_comp_processes_for_API(int comp_id, int API_id, MPI_Comm comm, const char *hint, const char *annotation)
{
	...
	if (API_id == -1)
		strcpy(API_label_local, "C-Coupler internal call");
	else get_API_hint(-1, API_id, API_label_local);
    ...
    if (local_process_id == 0) {
        for (int i = 1; i < num_processes; i ++) {
			if (API_ids[i] == -1)
				strcpy(API_label_another, "C-Coupler internal call");
            else get_API_hint(comp_id, API_ids[i], API_label_another);
...
template <class T> void check_API_parameter_scalar(int comp_id, int API_id, MPI_Comm comm, const char *hint, T value, const char *parameter_name, const char *annotation)
{
    ...
    if (local_process_id == 0) {
        ...
        for (i = 1; i < num_processes; i ++) {
            if (hint != NULL)
                EXECUTION_REPORT(REPORT_ERROR, comp_id, values[0] == values[i], "Error happens when calling the API \"%s\" for %s: parameter of %s is not consistent among processes of component \"%s\". Please check the model code related to the annotation \"%s\"",
                                 API_label, hint, parameter_name, comp_comm_group_mgt_mgr->search_global_node(comp_id)->get_comp_name(), annotation);
            else EXECUTION_REPORT(REPORT_ERROR, comp_id, values[0] == values[i], "Error happens when calling the API \"%s\": parameter of %s is not consistent among processes of component \"%s\". Please check the model code related to the annotation \"%s\"",
...
void check_API_parameter_decomp(int comp_id, int API_id, MPI_Comm comm, const char *hint, int decomp_id, const char *parameter_name, const char *annotation)
{
	int decomp_class;
    char API_label[NAME_STR_SIZE];
	...
	if (decomp_id != -1) {
		EXECUTION_REPORT_ERROR_OPTIONALLY(REPORT_ERROR, comp_id, decomps_info_mgr->is_decomp_id_legal(decomp_id), "ERROR happens when calling the API \"%s\" for %s: the input parameter of \"%s\" is not a legal parallel decompsition ID. Please check the model code related to the annotation \"%s\"", API_label, hint, parameter_name, annotation);
        check_API_parameter_string(comp_id, API_id, comm, hint, decomps_info_mgr->get_decomp_info(decomp_id)->get_decomp_name(), parameter_name, annotation);
        check_API_parameter_string(comp_id, API_id, comm, hint, comp_comm_group_mgt_mgr->search_global_node(decomps_info_mgr->get_decomp_info(decomp_id)->get_comp_id())->get_full_name(), parameter_name, annotation);
	}
}


void check_API_parameter_comp_or_grid(int comp_or_grid_id, int API_id, MPI_Comm comm, const char *hint, const char *parameter_name, const char *annotation)
{
	int comp_id, temp_int;
    char API_label[NAME_STR_SIZE];


    get_API_hint(comp_id, API_id, API_label);
	
    EXECUTION_REPORT(REPORT_ERROR, -1, comp_comm_group_mgt_mgr->is_legal_local_comp_id(comp_or_grid_id,true) || original_grid_mgr->is_grid_id_legal(comp_or_grid_id), "ERROR happens when calling the API \"%s\" for %s: the input parameter of \"%s\" is not a legal component model or grid ID. Please check the model code related to the annotation \"%s\"", API_label, hint, parameter_name, annotation);	
	...
	if (comm == MPI_COMM_NULL)
		comm = comp_comm_group_mgt_mgr->get_comm_group_of_local_comp(comp_id,"check_API_parameter_comp_or_grid");
	synchronize_comp_processes_for_API(comp_id, API_id, comm, hint, annotation);
	temp_int = (comp_id == comp_or_grid_id)? 1 : 0;
	check_API_parameter_int(comp_id, API_id, comm, hint, temp_int, "comp_or_grid_id (using a grid id or a component id)", annotation);
	if (comp_id != comp_or_grid_id)
		check_API_parameter_string(comp_id, API_id, comm, hint, original_grid_mgr->get_original_grid(comp_or_grid_id)->get_grid_name(), parameter_name, annotation);
}
...
void check_API_parameter_field_instance(int comp_id, int API_id, MPI_Comm comm, const char *hint, int field_id, const char *parameter_name, const char *annotation)
{
    ...
    EXECUTION_REPORT(REPORT_ERROR, comp_id, memory_manager->check_is_legal_field_instance_id(field_id), "ERROR happens when calling the API \"%s\" for %s: the input parameter of \"%s\" contains illegal field instance ID. Please check the model code related to the annotation \"%s\"", API_label, hint, parameter_name, annotation);
	...
	check_API_parameter_decomp(comp_id, API_id, comm, hint, field_instance->get_decomp_id(), parameter_name, annotation); 	
...
void check_API_parameter_string(int comp_id, int API_id, MPI_Comm comm, const char *hint, const char *string, const char *parameter_name, const char *annotation)
{
    ...
    EXECUTION_REPORT(REPORT_ERROR, comp_id, local_string_size > 0, "Error happens when calling the API \"%s\" for %s: parameter of %s is an empty string. Please check the model code related to the annotation \"%s\"", API_label, hint, parameter_name, annotation);
    EXECUTION_REPORT(REPORT_ERROR, -1, MPI_Comm_rank(comm, &local_process_id) == MPI_SUCCESS);
    EXECUTION_REPORT(REPORT_ERROR, -1, MPI_Comm_size(comm, &num_processes) == MPI_SUCCESS);
    ...
    if (local_process_id == 0) {
        ...
        for (int i = 1; i < num_processes; i ++)
            if (comp_id != -1)
                EXECUTION_REPORT(REPORT_ERROR, comp_id, all_string_size[0] == all_string_size[i], "Error happens when calling the API \"%s\" for %s: parameter of %s is not consistent among processes of component \"%s\". Please check the model code related to the annotation \"%s\"",
                                 API_label, hint, parameter_name, comp_comm_group_mgt_mgr->search_global_node(comp_id)->get_comp_name(), annotation);
            else EXECUTION_REPORT(REPORT_ERROR, comp_id, all_string_size[0] == all_string_size[i], "Error happens when calling the API \"%s\" for %s: parameter of %s is not consistent among processes. Please check the model code related to the annotation \"%s\"",
        ...
        for (int i = 1; i < num_processes; i ++)
            if (comp_id != -1)
                EXECUTION_REPORT(REPORT_ERROR, comp_id, strncmp(all_string_para, all_string_para+local_string_size*i, local_string_size) == 0, 
                                 "Error happens when calling the API \"%s\" for %s: parameter of %s is not consistent among processes of component \"%s\". Please check the model code related to the annotation \"%s\"",
                                 API_label, hint, parameter_name, comp_comm_group_mgt_mgr->search_global_node(comp_id)->get_comp_name(), annotation);
                                  ...
                                  "Error happens when calling the API \"%s\" for %s: parameter of %s is not consistent among processes. Please check the model code related to the annotation \"%s\"",
                                  API_label, hint, parameter_name, annotation);            
    }
