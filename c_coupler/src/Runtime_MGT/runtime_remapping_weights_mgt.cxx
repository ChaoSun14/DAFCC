...
Runtime_remapping_weights::Runtime_remapping_weights(const char *src_comp_full_name, const char *dst_comp_full_name, Original_grid_info *src_original_grid, Original_grid_info *dst_original_grid, Remapping_setting *remapping_setting, Decomp_info *dst_decomp_info)
{
    ...
    if (src_original_grid->get_H2D_sub_CoR_grid() != NULL) {
        ...
        else EXECUTION_REPORT_ERROR_OPTIONALLY(REPORT_ERROR, -1, "Software error in Runtime_remapping_weights::Runtime_remapping_weights: wrong H2D algorithm");
    ...
    if (src_original_grid->get_V1D_sub_CoR_grid() != NULL) {
        ...
        else EXECUTION_REPORT_ERROR_OPTIONALLY(REPORT_ERROR, -1, "Software error in Runtime_remapping_weights::Runtime_remapping_weights: wrong V1D algorithm");
    ...
    if (src_original_grid->get_Time1D_sub_CoR_grid() != NULL) {
        ...
        else EXECUTION_REPORT_ERROR_OPTIONALLY(REPORT_ERROR, -1, "Software error in Runtime_remapping_weights::Runtime_remapping_weights: wrong T1D algorithm");        
    ...
    if (H2D_remapping_weight_file != NULL) {
        ...
        EXECUTION_REPORT_ERROR_OPTIONALLY(REPORT_ERROR, -1, H2D_grid_decomp_mask == NULL, "Software error in Runtime_remapping_weights::Runtime_remapping_weights");
		...
		sequential_remapping_weights->write_overall_H2D_remapping_weights(comp_comm_group_mgt_mgr->search_global_node(dst_comp_full_name)->get_comp_id(), src_original_grid->get_grid_id(), dst_original_grid->get_grid_id());
    }    
...
Runtime_remapping_weights_container::Runtime_remapping_weights_container(const char *src_comp_full_name, const char *dst_comp_full_name, Original_grid_info *src_original_grid, Original_grid_info *dst_original_grid, Remapping_setting *remapping_setting, Decomp_info *dst_decomp_info)
{
    this->src_comp_full_name = strdup(src_comp_full_name);
    this->dst_comp_full_name = strdup(dst_comp_full_name);
    this->src_original_grid = src_original_grid;
	...
	if (dst_original_grid->get_max_sub_grid_under_V3D() != NULL) {
		...
		runtime_remapping_weights_under_V3D = runtime_remapping_weights_mgr->search_or_generate_runtime_remapping_weights(src_comp_full_name, dst_comp_full_name, src_original_grid->get_max_sub_grid_under_V3D(), dst_original_grid->get_max_sub_grid_under_V3D(), remapping_setting, dst_decomp_info);
	...
	if (dst_original_grid->get_Time1D_sub_grid() != NULL) {
		...
		runtime_remapping_weights_Time1D = runtime_remapping_weights_mgr->search_or_generate_runtime_remapping_weights(src_comp_full_name, dst_comp_full_name, src_original_grid->get_Time1D_sub_grid(), dst_original_grid->get_Time1D_sub_grid(), remapping_setting, dst_decomp_info);
	}	
