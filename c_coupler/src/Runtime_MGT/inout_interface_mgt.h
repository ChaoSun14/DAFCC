...
enum
{
    ...
    COUPLING_INTERFACE_MARK_HALO_EXCHANGE
};
...
class Inout_interface
{
    private:
        ...
        Inout_interface *parent_interface;
        std::vector<Decomp_info*> halo_regions;
        int execution_checking_status;
        long last_execution_time;
        bool is_last_halo_exchange_waited;
    ...
    public:
        ...
        Inout_interface(const char *, int, int, int *, int *, int, int, int, int, int, const char *);
        Inout_interface(const char*, int, int, int*, int*, int, int, const char *);
        ...
        void do_halo_exchange(int, bool, const char *);
        void finish_halo_exchange(int, const char *);
        Inout_interface *get_child_interface(int i);
        int get_num_coupling_procedures() { return coupling_procedures.size(); }
        void add_remappling_fraction_processing(void *, void *, int, int, const char *, int, const char *);        
		...
		Inout_interface *get_parent_interface() { return parent_interface; }
		void get_sender_time(int, int, int, int*, int*, int*, const char*);
		int get_fields_mem_registered() { return fields_mem_registered.size(); }
		bool get_field_connected_status(int i) { return fields_connected_status[i]; }
};
...
class Inout_interface_mgt
{
    ...
    public:
        ...
        int register_normal_remap_interface(const char *, int, int *, int *, int, int, int, int, int, const char *);
        int register_frac_based_remap_interface(const char *, int, int *, int *, int, int, int, int, void *, void *, int, int, const char *, int, const char *);
        int register_halo_exchange_interface(const char *, int, int *, int *, int, int, const char *);
        ...
        void execute_halo_exchange(int, int, bool, const char *);
        void execute_halo_exchange(int, int, const char *, bool, const char *);        
        void finish_halo_exchange(int, int, const char *);
        void finish_halo_exchange(int, int, const char *, const char *);
		...
		void finalize_inout_interface(int);		
		bool do_coupling_generation_between_interfaces_intra_one_component_model(Inout_interface *, Inout_interface *, int, bool);
};
