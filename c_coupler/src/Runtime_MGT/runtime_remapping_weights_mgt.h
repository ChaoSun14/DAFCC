...
class Runtime_remapping_weights
{
    private:
        ...
        Field_mem_info *intermediate_V3D_grid_bottom_field;    // surface field for src grid in general and for dst grid corresponding to external surface field
...
class Runtime_remapping_weights_container
{
    private:
		int comp_id;
        const char *src_comp_full_name;
		...
		Runtime_remapping_weights *runtime_remapping_weights_Time1D;
		Remap_grid_data_class *temp_remap_data_after_remapping_under_V3D;
		Remap_grid_class *interchange_grid_before_remapping_under_V3D;
		Remap_grid_class *interchange_grid_after_remapping_under_V3D;
		Remap_grid_class *interchange_grid_before_remapping_Time1D;
		Remap_grid_class *interchange_grid_after_remapping_Time1D;
		Remap_grid_data_class *partial_data_field_for_src_remapping_under_V3D;
		Remap_grid_data_class *partial_data_field_for_dst_remapping_under_V3D;
		Remap_grid_data_class *partial_data_field_for_src_remapping_Time1D;
		Remap_grid_data_class *partial_data_field_for_dst_remapping_Time1D;

	public:
		Runtime_remapping_weights_container(const char*, const char*, Original_grid_info *, Original_grid_info *, Remapping_setting *, Decomp_info*);
		~Runtime_remapping_weights_container();
		void do_remap(Remap_grid_data_class*, Remap_grid_data_class*);
		Runtime_remapping_weights *get_runtime_remapping_weights_under_V3D() { return runtime_remapping_weights_under_V3D; }
		Runtime_remapping_weights *get_runtime_remapping_weights_Time1D() { return runtime_remapping_weights_Time1D; }
        Original_grid_info *get_src_original_grid() { return src_original_grid; }
        Original_grid_info *get_dst_original_grid() { return dst_original_grid; }
		bool is_empty();
};
