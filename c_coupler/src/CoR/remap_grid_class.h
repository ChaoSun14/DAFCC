...
class Remap_grid_class
{
    ...
    public:
		...
		bool have_the_same_dimensions_with(Remap_grid_class *); 
        ...
        void compute_remap_field_data_runtime_mask(Remap_grid_class*, Remap_grid_class **, int*, Remap_grid_data_class **, bool);
		...
		bool has_V3D_sub_grid();
		Remap_grid_class *get_V3D_sub_grid();
		...
		Remap_grid_class *get_ordered_similar_grid_under_V3D();
		bool get_is_empty_grid();
		void set_empty_grid() { is_empty_grid = true; }
};
